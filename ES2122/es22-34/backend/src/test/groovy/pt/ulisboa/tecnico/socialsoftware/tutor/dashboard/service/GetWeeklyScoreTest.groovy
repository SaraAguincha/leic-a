...
class GetWeeklyScoreTest extends SpockTest {
    ...
    def "get ordered weekly scores"() {
        ...
        weeklyScoreDtoOne.getWeek() == LocalDateTime.parse(week.atStartOfDay().toString()).toString()
        ...
        weeklyScoreDtoTwo.getWeek() == LocalDateTime.parse(week.minusDays(50).atStartOfDay().toString()).toString()
    }
