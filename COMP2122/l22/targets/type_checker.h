...
namespace l22 {
  ...
  public:
    type_checker(std::shared_ptr<cdk::compiler> compiler, cdk::symbol_table<l22::symbol> &symtab, std::shared_ptr<l22::symbol> func, 
  ...
  protected:
    ...
    void processIntDouExpression(cdk::binary_operation_node *const node, int lvl);
    void processPtrIntDouExpression(cdk::binary_operation_node *const node, int lvl);
    void processLogicalExpression(cdk::binary_operation_node *const node, int lvl);
    void processComparasionExpression(cdk::binary_operation_node *const node, int lvl);
